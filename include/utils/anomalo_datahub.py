...
def anomalo_to_datahub(api_client: anomalo.Client, start_date: str, end_date: str) -> None:
    ...
    configured_warehouses = api_client.list_warehouses()['warehouses']
    platforms = list(set([warehouse['warehouse_type'] for warehouse in configured_warehouses]))
    ...
    warehouse_mapping = {warehouse['id']: warehouse['name'] for warehouse in configured_warehouses}
    ...
    for configured_table in configured_tables:
        ...
        # For example, everything after /browse/dataset/prod/platform/DW_NAME
        ...
        platform_mapping = {warehouse['name']: warehouse['warehouse_type'] for warehouse in configured_warehouses}
