...
snowflake_cocktails_stage_table = 'qbiz-snowflake-sandbox-pipeline.public.cocktails_stage'
...
def sandbox_data_pipeline():
    ...
    anomalo_checks_cocktails_snowflake = run_anomalo_checks.override(task_id='anomalo_checks_cocktails_snowflake')(table_name=snowflake_cocktails_stage_table)
    ...
    write_cocktails_to_snowflake_stage_task >> anomalo_checks_cocktails_snowflake >> write_cocktails_to_snowflake_task
